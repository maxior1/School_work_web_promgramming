...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2024 at 11:45 AM
...
(2, 'Lambo-Bluery Geff', 'The Aventador style combines pure lines and a sporting essence that magisterially blend together in the latest masterpiece of the range. Here, aesthetic perfection and unequaled performance come to life without compromise.', 690000, 5, 'jpg', 1),
...
--
ALTER TABLE `products`
  MODIFY `p_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
